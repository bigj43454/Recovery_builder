...
export BRANCH="twrp-14.0" # the branch of manifest

# about your device
export DEVICE="emerald" # codename used in device tree
...
export TYPE="emerald" # recovery type: omni, twrp, something else
